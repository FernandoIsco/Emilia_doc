...
<style scoped>
  .header {display: flex; flex-direction: row-reverse; position: relative; height: 40px; background-color: #fff; padding: 10px 100px;box-shadow: 0 0 1px rgba(0,0,0,0.25);}
